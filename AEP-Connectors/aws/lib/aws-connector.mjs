...
export const SPEC = {
  ...
  service: "aws",
  label: "AWS",
  upstream: "https://sts.amazonaws.com",
  authTokenEnv: "AEP_AWS_SESSION_TOKEN",
  keywords: ["aws","amazon web services","s3","lambda","ec2"],
};
...
export function awsConnectorExtension(config) {
