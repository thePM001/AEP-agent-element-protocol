...
export const SPEC = {
  ...
  service: "n8n",
  label: "n8n",
  upstream: "https://your-instance.app.n8n.cloud/api/v1",
  authTokenEnv: "AEP_N8N_API_KEY",
  keywords: ["n8n","n8n workflow","n8n automation","workflow automation"],
};
...
export function n8nConnectorExtension(config) {
