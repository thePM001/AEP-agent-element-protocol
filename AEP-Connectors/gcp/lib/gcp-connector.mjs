...
export const SPEC = {
  ...
  service: "gcp",
  label: "Google Cloud",
  upstream: "https://cloudresourcemanager.googleapis.com",
  authTokenEnv: "AEP_GCP_ACCESS_TOKEN",
  keywords: ["gcp","google cloud","google cloud project","gcloud"],
};
...
export function gcpConnectorExtension(config) {
