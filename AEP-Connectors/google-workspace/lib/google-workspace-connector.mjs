...
export const SPEC = {
  ...
  authTokenEnv: "AEP_GWS_ACCESS_TOKEN",
  keywords: ["google workspace","gws","gmail","google drive","google calendar"],
};
...
export function google_workspaceConnectorExtension(config) {
