...
export const SPEC = {
  ...
  service: "make",
  label: "Make",
  upstream: "https://eu1.make.com/api/v2",
  authTokenEnv: "AEP_MAKE_API_TOKEN",
  keywords: ["make","make.com","integromat","make scenario","make automation"],
};
...
export function makeConnectorExtension(config) {
