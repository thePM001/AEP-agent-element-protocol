# AEP 2.75 Agent Skill

This skill loads the AEP 2.75 agent harness and governance configuration.
...
- AEP-Graph orchestration (stateful cyclic workflows)
- MCP Security Gateway (poisoning, typosquatting, drift)
- CLI tools (doctor, verify, lint-policy, red-team)
- Multi-language policies (GAP, OPA Rego, Cedar)
