...
This library is the AEP 2.8.6 UCB perimeter profile. Default profile is signed provenance, schema with byte caps, scanner-backed content checks and a replay window. Paper 005 VSA stays off unless named. Named profile paper005-vsa is not a substitute for manifests, signatures and SSRF controls.
