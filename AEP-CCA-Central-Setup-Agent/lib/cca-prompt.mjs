...
- dynAEP protocol lives in AEP-Components/dynAEP/; SDKs in internal-export-area/AEP-SDKs/ only. Set policy_overrides.dynaep (lattice registry, governance_mode, sdk_paths, observers).
