...
// SECTION: - Per-Session Cache Entry
...
class SessionPolicyCache {
    ...
    // SECTION: - PID Tracking (called from NOTIFY_FORK/EXIT)
    ...
    // SECTION: - File Policy Evaluation
    ...
    // SECTION: - Network Policy Evaluation
    ...
    // SECTION: - Exec Policy Evaluation
    ...
    // SECTION: - DNS Policy Evaluation (union of all sessions)
    ...
    // SECTION: - Darwin Notification Listener
