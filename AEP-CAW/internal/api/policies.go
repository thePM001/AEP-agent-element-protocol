...
// createPolicy does not mutate enforcement (not implemented / fail closed).
// Matches update/delete: on-disk edit + reload only.
func (a *App) createPolicy(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, http.StatusNotImplemented, map[string]any{
		"error": "policy create is not implemented for enforcement; edit on-disk policies and reload",
	})
}

// updatePolicy does not mutate enforcement (not implemented / fail closed).
func (a *App) updatePolicy(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusNotImplemented, map[string]any{
		"error":     "policy update is not implemented for enforcement; edit on-disk policies and reload",
		"policy_id": policyID,
	})
}

// deletePolicy removes a policy.
// deletePolicy does not mutate enforcement (not implemented / fail closed).
func (a *App) deletePolicy(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusNotImplemented, map[string]any{
		"error":     "policy delete is not implemented for enforcement; edit on-disk policies and reload",
		"policy_id": policyID,
	})
}
