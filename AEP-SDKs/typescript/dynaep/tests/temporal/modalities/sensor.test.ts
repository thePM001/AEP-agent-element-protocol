// @PAD: /root/dynAEP/sdk/typescript/tests/temporal/modalities/sensor.test.ts
// ===========================================================================
...
export function testEvaluatePollingEfficiency(): void {
  test("evaluatePollingEfficiency returns efficiency class string", () => {
    const efficiency = evaluatePollingEfficiency(30000, 300);
    assert(
      efficiency === "efficient" || efficiency === "wasteful" || efficiency === "borderline",
      "Should return efficiency class, got " + efficiency,
    );
  });
}
