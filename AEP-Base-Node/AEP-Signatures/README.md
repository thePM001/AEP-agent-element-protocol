...
**Location:** `AEP-Base-Node/AEP-Signatures/` (Base Node kernel adjunct, default wired, operator accessible)
...
```bash
node AEP-Base-Node/AEP-Signatures/tooling/validate-signatures.mjs
```

## Licensing

- **Signature content** (`signatures/`, `schemas/`, `trust-bundle/`): CC BY-SA 4.0
- **Tooling** (`tooling/`, `lib/`): Apache 2.0
