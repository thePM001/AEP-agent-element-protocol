...
export function loadSignaturesContext(repoRoot, env = process.env) {
  ...
  return {
    ...
    principles: [
      ...
      "Scanners and validation dock consume signatures from AEP-Base-Node/AEP-Signatures/.",
    ],
  };
}
...
export function formatSignaturesForPrompt(ctx) {
  ...
  const lines = [
    "",
    "EPSCOM Detection Signatures (AEP-Base-Node/AEP-Signatures/, default wired):",
