...
File: `AEP-Base-Node/AEP-Registry/profiles/as-single-polar.json`
...
| File | Purpose |
| --- | --- |
| `AEP-Base-Node/AEP-Registry/nodes.json` | Registry example (single primary) |
| `AEP-Base-Node/AEP-Registry/schemas/nodes-registry-v2.json` | JSON schema v2 |

## Rust crate

`AEP-Base-Node/AEP-Multi-Base-Node/crate/` (`multi-base-node-core`)
...
`AEP-Base-Node/AEP-Multi-Base-Node/docs/multi-base-node-artifact-manifest.json` lists all shipped 2.8b artifacts.