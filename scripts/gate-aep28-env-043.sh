...
cd "$ROOT"
cargo test --manifest-path retired-archive/instruction-crates/satisfied-actions-partition/crate/Cargo.toml --lib
cargo run -q --manifest-path retired-archive/instruction-crates/satisfied-actions-partition/crate/Cargo.toml
