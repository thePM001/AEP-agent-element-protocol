{
  ...
  "pattern": {
    ...
    "invariants": [
      ...
      {"expr": "containerized-modular-deploy", "lang": "gapdsl", "severity": "critical", "description": "Base Node kernel deploys via Docker or kernel admit dock only"},
      ...
      {"expr": "composer-lite-wasm-lattice-proxy", "lang": "gapdsl", "severity": "critical", "description": "hyperlattice /api/wasm routes through the lattice channel socket only"},
      ...
      {"expr": "setup-agent-inference-lattice-register", "lang": "gapdsl", "severity": "critical", "description": "INFERENCE_ENGINE_REGISTER sealed as a LatticeChannelFrame on the kernel admit dock"},
