...
See [`AEP-Docks/README.md`](../../AEP-Docks/README.md) and [`AEP-Components/lattice-channels/README.md`](../../AEP-Components/lattice-channels/README.md) for the wire. This how-to does not replace those specs and only states the wrap rule: no dock channel, no wrap.
