...
const INDEX = join(REPO, "internal-export-area/AEP-SDKs/typescript/aep-protocol/src/index.ts");
...
const MAP = {
  ...
  "./trust/": "../../../../internal-export-area/retired/trust-rings/lib/trust/",
  "./rings/": "../../../../internal-export-area/retired/trust-rings/lib/rings/",
...
console.log("Rewrote internal-export-area/AEP-SDKs/typescript/aep-protocol/src/index.ts");