#!/usr/bin/env node
/** Generate connector lib stubs from internal-export-area/AEP-Connectors/catalog.json */
...
import { probeTcpHost } from "../../../AEP-CCA-Central-Setup-Agent/lib/environment-probe.mjs";
import {
  buildEgressRoutes,
  connectorExtension,
  probeHttpsRoot,
...
for (const spec of catalog.connectors) {
  const dir = join(REPO, "internal-export-area/AEP-Connectors", spec.folder);
