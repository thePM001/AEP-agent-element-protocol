# AEP v2.8.6 ASV Protocol (Incomplete Code Verification)
...
The ASV protocol prevents AI coding agents from producing stub code, facades, dead code or incomplete implementations while reporting them as complete. It is a mandatory component of all AEP v2.8.6+ compliant agent harnesses.
...
All AEP v2.8.6+ compliant platforms MUST expose a biosecurity eligibility check at the `/aepassist` endpoint (or equivalent interface).
...
An AEP v2.8.6+ compliant agent harness MUST:
