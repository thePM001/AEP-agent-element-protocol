...
**dynAEP is the main AEP event runtime.** Base Node is the local kernel. Composer Lite is the operator / CCA plane. CCA (`aep-cca` / `aep-setup-agent`) plans and activates components.

Public repo: https://github.com/thePM001/AEP-agent-element-protocol

**Operators:** [AEP secure deployment guide](../docs/AEP-2.8-SECURE-DEPLOYMENT-GUIDE.md) (Path A native lattice, Path B optional UCB).
...
| dynAEP SDK | `internal-sdk/AEP-SDKs/typescript/dynaep/` |
...
Full skill body (layers, dynAEP tools, scanners, checklist): see `SKILL.md` in this directory.
