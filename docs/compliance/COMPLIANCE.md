# AEP Compliance Mapping

**Honesty:** Feature-to-article rows below describe **technical control bindings** for the EU AI Act LRP checking pack. They are not a legal certification claim.

**Runtime enforcement:** one definition `AEP-Components/eu-ai-act-checker/EU-AI-ACT-PACK.json` and one gate `AEP-Components/eu-ai-act-checker/gates/gate-eu-ai-act.sh`.


This document maps AEP features to requirements in the EU AI Act, SOC 2 Type II, HIPAA and related frameworks. For LRP module install options and dock wiring see [COMPLIANCE-LRP.md](./COMPLIANCE-LRP.md).
...
| Art. 15 - Accuracy, Robustness and Cybersecurity | Execution Rings (least privilege), Forbidden Patterns, Structural Validation; Policy Builder invariant validation; MCP Security Gateway (tool poisoning, typosquatting and drift detection) |
...
| Art. 61 - Post-Market Monitoring | Evidence Ledger, Merkle Proofs and RFC 3161 Timestamps |
...
| CC7.3 - Evaluation of Events | Escalation Rules and Evidence Ledger |
| CC7.4 - Incident Response | Kill Switch, Rollback, Session Termination; Fleet Manager with pause/resume/kill capabilities |
| CC8.1 - Change Management | Optimistic Concurrency (_version), Rollback and Compensation Plans; Policy Builder spectral impact projection for rule changes |
...
| 164.312(c) - Integrity | Merkle Tree per-entry verification, Post-Quantum Signatures; Policy Builder coverage tracking |
