...
@objc protocol AepCawXPCProtocol {
    ...
    // SECTION: - PNACL (Process Network ACL)
    ...
    // SECTION: - PNACL Approval Flow (Phase 3)
    ...
    // SECTION: - PNACL Configuration (Phase 4)
    ...
    // SECTION: - Process Muting (Recursion Guard)
