...
func (a *App) execInSessionPTYWS(w http.ResponseWriter, r *http.Request) {
	...
	up := websocket.Upgrader{
		// MEDIUM: same-origin or explicit AEP_CAW_WS_ORIGINS allowlist (comma-separated)
		CheckOrigin: func(r *http.Request) bool {
			...
			allow := strings.TrimSpace(os.Getenv("AEP_CAW_WS_ORIGINS"))
			if allow == "" || allow == "*" {
				// Default: require Origin host match Host header
