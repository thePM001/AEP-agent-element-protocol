// Standalone Rust dynAEP. Action Lattice membership, parent
// Wall_time closes on missing timestamps.
// closure and agent_permission match the kernel.
// Partition satisfied_actions by agent or session so parent closure cannot leak across agents. Temporal authority and perception
