...
```yaml
aep_sources:
  scene: "./internal-export-area/AEP-Subprotocols/ui/aep-scene.json"
  registry: "./internal-export-area/AEP-Subprotocols/ui/aep-registry.yaml"
  theme: "./internal-export-area/AEP-Subprotocols/ui/aep-theme.yaml"
```
...
| **Default** | `"./internal-export-area/AEP-Subprotocols/ui/aep-scene.json"` |
| **Description** | Path to the scene-graph JSON file. Describes the UI element tree (containers, widgets, layout). |
| **Example** | `scene: "./internal-export-area/AEP-Subprotocols/ui/aep-scene.json"` |
| **NEW** | No |
...
| **Type** | `string` (file path) |
| **Default** | `"./internal-export-area/AEP-Subprotocols/ui/aep-registry.yaml"` |
...
| **Example** | `registry: "./internal-export-area/AEP-Subprotocols/ui/aep-registry.yaml"` |
| **NEW** | No |
...
| **Type** | `string` (file path) |
| **Default** | `"./internal-export-area/AEP-Subprotocols/ui/aep-theme.yaml"` |
| **Description** | Path to the default theme definition (used as fallback when `themes.active` is invalid or missing). |
| **Example** | `theme: "./internal-export-area/AEP-Subprotocols/ui/aep-theme.yaml"` |
| **NEW** | No |
