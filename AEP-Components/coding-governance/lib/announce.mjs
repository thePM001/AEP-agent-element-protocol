...
import { invokeCodingGovernanceRust } from "../../../internal-export-area/AEP-SDKs/typescript/aep-protocol/lib/subprotocol-rust.mjs";
...
export function runAnnounce({
  ...
  const payload = {
    ...
    // MEDIUM: never default to high trust; provisional max is 200
    trust_score: trustScore ?? taskManifest.trust?.max_trust_score ?? 200,
