import { z } from "zod";
import { ModelGatewayPolicySchema } from "../../../model-gateway/lib/types.js";
import { CommercePolicySchema } from "../../../commerce/lib/types.js";
import { FleetPolicySchema } from "../../../fleet/lib/types.js";
...
export interface AgentAction {
  ...
  timestamp: Date;
  /** Agent id for identity-gated evaluate paths */
  agentId?: string;
  /** PEM or raw public key material when identity.require_agent_identity */
  publicKey?: string;
  /** Detached signature (base64) over canonical tool+input */
  signature?: string;
}
